      ...
      <div className="admin-main">
        ...
        <div className="admin-page">
          ...
          <div className="list-toolbar">
            ...
            <a href="ingredient.html?new=1" className="btn-sm primary" style={{ textDecoration: "none" }}>+ New ingredient</a>
          </div>
            ...
            <div className="list-table">
              ...
              {rows && filtered.length === 0 && (
                <div className="list-empty">
                  ...
                  {!q && <a href="ingredient.html?new=1" className="btn-sm primary" style={{ textDecoration: "none" }}>+ New ingredient</a>}
                </div>
              )}
              {rows && filtered.map((r) => (
                <div key={r.id} className="list-row" onClick={() => { location.href = `ingredient.html?id=${encodeURIComponent(r.id)}`; }}>
