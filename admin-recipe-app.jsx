  ...
  return (
    <>
      ...
      <FormCard title="Hero photograph" scribble="the money shot">
        <Field label="Hero image path" hint="Relative path under data/recipe-bundles/{id}/hero.jpg or similar.">
          <input className="input mono" value={r.hero_image} onChange={(e) => update({ hero_image: e.target.value })} placeholder="data/recipe-bundles/paneer-butter-masala/hero.jpg" />
        </Field>
      </FormCard>
